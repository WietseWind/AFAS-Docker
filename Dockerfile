...
RUN apt-get -y --force-yes install nano expect ssmtp mutt supervisor htop wget curl git lynx locales python-software-properties software-properties-common && \
    add-apt-repository ppa:ondrej/php -y && \
    apt-get -y --force-yes update && \
    apt-get -y --force-yes upgrade && \
    apt-get -y --force-yes install libcurl4-openssl-dev pkg-config libmcrypt4 enchant aspell-en aspell dictionaries-common php-common apache2 apache2-bin apache2-data ssl-cert
